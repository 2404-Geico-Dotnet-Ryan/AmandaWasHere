class BakedGoods
{
    ...
    public BakedGoods()
    {
        Food bakeGood1 = new(idCounter++, "Plain Bagel", 1.49, true, 0);
        Food bakeGood2 = new(idCounter++, "Everything Bagel", 1.99, true, 0);
        Food bakeGood3 = new(idCounter++, "Cinnamon Raisin Bagel", 2.09, true, 0);

        Food bakeGood4 = new(idCounter++, "Chocolate Chip Cookies", 1.50, true, 0);
        Food bakeGood5 = new(idCounter++, "Peanut Butter Cookies", 1.50, true, 0);
        Food bakeGood6 = new(idCounter++, "Salted Caramel Cookies", 1.50, true, 0);

        Food bakeGood7 = new(idCounter++, "Sourdough Bread", 4.87, true, 0);
        Food bakeGood8 = new(idCounter++, "Sandwich Bread", 4.87, true, 0);
        Food bakeGood9 = new(idCounter++, "Artisan Bread", 4.87, true, 0);
