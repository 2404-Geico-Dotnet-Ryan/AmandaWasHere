class Program
{
    ...
    //     double result1 = Completed.ArrayAverage([1, 2, 3, 4]);
    //     double result2 = Completed.ArrayAverage([-1, -2, -3]);
    //     double result3 = Completed.ArrayAverage([0]);
    ...
    //     bool result1 = Completed.IsAnagram("listen", "silent");
    //     bool result2 = Completed.IsAnagram("hello", "world");
    //     bool result3 = Completed.IsAnagram("", "");
